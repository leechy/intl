...
const direction = require('./direction-6d3cf5ce.js');
...
const Dictionary = class {
    constructor(hostRef) {
        ...
        this.default = 'en';
        this.onIntlChange = core.createEvent(this, "intlChange", 7);
    }
    async langChanged() {
...
exports.intl_dictionary = Dictionary;
